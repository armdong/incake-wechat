	...
	$(function() {
		...
		$('.img-add').click(function(){
			...
			if($(this).hasClass('inner-number')){//数字蜡烛
				...
				$('.buyBtn').before(
						"<div class="+"'buyBtm buy1 clearfix'"+"><span class="+"'count'"+">数字1：</span><span class="
						+"'countR'"+"><button class="+"'subtract'"+">－</button><input class="+"'number'"
						+" type="+"'text'"+" value="+"'1'"+" style='margin:0 .3rem;' /><button class="+"'add'"+">＋</button>	</span></div>");
			}else{//其他
				$('.buyMde').addClass('hide');
				$('.buyBtn').before(
						"<div class="+"'buyBtm buyNumber clearfix'"+"><span class="+"'count'"+">数量：</span><span class="
						+"'countR'"+"><button class="+"'subtract'"+">－</button><input class="+"'number'"
						+" type="+"'text'"+" value="+"'1'"+" style='margin:0 .3rem;' /><button class="+"'add'"+">＋</button>	</span></div>");
			}
		...
		$(".buyMde-list .type").click(function() {
			...
			if($(this).hasClass('cur')){
				$('.buyBtn').before(
						"<div class="+"'buyBtm buy"+this.text+" clearfix'"+"><span class="+"'count'"+">数字"+this.text+"</span><span class="
						+"'countR'"+"><button class="+"'subtract'"+">－</button><input class="+"'number'"
						+" type="+"'text'"+" value="+"'1'"+" style='margin:0 .3rem;' /><button class="+"'add'"+">＋</button>	</span></div>");
			}else{

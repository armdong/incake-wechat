(function() {
    ...
    $(function() {
        ...
        var $oBtnMore = $('#find-more'),
            ...
            $oPortal = $('#portal'),
            $oBtnProtal = $oPortal.find('.btn-portal');
        ...
        // 注册按钮点击事件
        function fnRegister(){
            var $oMaskRegister = $('#mask-register'),
                $oBtnRegisterClose = $oMaskRegister.find('.frm-register-close'),
            ...
            $oBtnProtal.on('click', function(){
                $oMaskRegister.fadeIn();
            });

            $oBtnRegisterClose.on('click', function(event){
                $oMaskRegister.fadeOut();
            });
        }
